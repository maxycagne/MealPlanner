...
import com.example.myapplication.Activity.ActivityEdit;
import com.example.myapplication.Activity.ViewPlanActivity;
import com.example.myapplication.Adapter.AllAdapter;
...
public class PlansFragment extends Fragment {
    ...
    private FragmentPlansBinding root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = FragmentPlansBinding.inflate(inflater,container,false);
           ...
           ((ActivityDashboard)getActivity()).getHandler().post(()->{
               try{
                   ...
                   else
                   {
                       ...
                       AllAdapter adapter = new AllAdapter(getContext(), fitnessPlansList, new AllAdapter.FitnessPlansClick() {
                           @Override
